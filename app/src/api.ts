...
export const loginPat = (token: string) => invoke<AuthState>("login_pat", { token });
...
) => invoke<CheckoutInfo>("create_worktree", { projectId, branch, base, createBranch, linked });
export const removeWorktree = (projectId: string, path: string, toTrash: boolean) =>
...
export const checkoutStatus = (path: string) => invoke<StatusMap>("checkout_status", { path });
export const openInEditor = (path: string) => invoke<void>("open_in_editor", { path });
export const openInTerminal = (path: string) => invoke<void>("open_in_terminal", { path });
...
export const spawnIssueWorktree = (projectId: string, number: number, title: string) =>
...
export const createPr = (projectId: string, checkoutPath: string, title: string, body: string) =>
...
export const dispatchWorkflow = (owner: string, repo: string, workflowId: number, ref: string) =>
  invoke<void>("dispatch_workflow", { owner, repo, workflowId, ref });
export const latestRunForBranch = (owner: string, repo: string, branch: string) =>
